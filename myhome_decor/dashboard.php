            ...
            <div class="container-fluid">
                <div class="row no-gutter">
                    <div class="col-lg-3 col-sm-8">
                        <a href="category_c.php?rowid=ruang_keluarga" class="portfolio-box">
                    ...
                    <div class="col-lg-3 col-sm-8">
                        <a href="category_c.php?rowid=ruang_kerja" class="portfolio-box">
                    ...
                    <div class="col-lg-3 col-sm-8">
                        <a href="category_c.php?rowid=kamar_mandi" class="portfolio-box">
                    ...
                    <div class="col-lg-3 col-sm-8">
                        <a href="category_c.php?rowid=kamar_tidur" class="portfolio-box">
                    ...
                    <div class="col-lg-3 col-sm-8">
                        <a href="category_c.php?rowid=ruang_tamu" class="portfolio-box">
                    ...
                    <div class="col-lg-3 col-sm-8">
                        <a href="category_c.php?rowid=dapur" class="portfolio-box">
                    ...
                    <div class="col-lg-3 col-sm-8">
                        <a href="category_c.php?rowid=taman" class="portfolio-box">
                    ...
                    <div class="col-lg-3 col-sm-8">
                        <a href="category_c.php?rowid=ruang_makan" class="portfolio-box">
