        ...
        ?>     
          ...
          <?php
            ...
            ?>
                  ...
                  <a href="tampilan_portofolio_c.php?p_id=<?php echo $results['title']?>&id=<?php echo $results['id_d']?>" class="portfolio-link">
                  ...
                  <div class="portfolio-caption">
                      ...
                      <a href="profil_designer_clientpov.php?rowid=<?php echo $results['id_d'] ?>"> <?php echo $results['first_name'];?> <?php echo $results['last_name'];?></a>
                  </div>
              </div>
              <?php
              }
