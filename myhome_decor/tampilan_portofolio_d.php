<?php
    ...
    $data1 = mysqli_fetch_array($album);
                ...
                <?php echo $userdata['username']; ?>
                  ...
                  <li>
                      ...
                      <ul class="dropdown-menu dropdown-user" style="font-family: "Raleway", sans-serif">
                        <li>
                          <a href="profil_designer.php"><i class="fa fa-user fa-fw"></i> <h3>User Profile</h3></a>
                        </li>
                        <li class="divider"></li>
                        <li>
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-threequarter">
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
        <h2 class="w3-text-teal w3-padding-16 text-center">Apartemen Nona Melati</h2>
        <p class="w3-text-grey text-center"> Designer : <a href="profil_fix.html"> Shinta Ratnasari </a></p>
