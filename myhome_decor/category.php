      ...
      <div class="container">
          ...
          while($data = mysqli_fetch_array($designer))
              ...
              <div class="col-md-4 col-sm-6 portfolio-item">
                  <a href="tampilan_portofolio.php?p_id=<?php echo $data['title']?>&id=<?php echo $data['id_d']?>" class="portfolio-link">
                  ...
                  <div class="portfolio-caption">
                      ...
                      <p class="text-muted">
                      Designer: <a href="profil_designer_notloggedinpov.php?rowid=<?php echo $data['id_d'] ?>"> <?php echo $data['first_name'];?> <?php echo $data['last_name'];?></a>
                  </div>
