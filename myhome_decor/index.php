...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand page-scroll" href="index.php">MYHOMEDECOR</a>
        </div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item active">
          <img src="img/slideshow/2.jpg" width=100%>
        ...
        <div class="item">
          <img src="img/slideshow/1.jpg" alt="Chicago" width=100%>
          <div class="carousel-caption">
            <h3>Kamar Tidur Utama Keluarga Ratnasari </h3>
            <p>by Malina Saumnuari </p>
          </div>
        ...
        <div class="item">
          <img src="img/slideshow/3.jpg" alt="Los Angeles" width=100%>
          <div class="carousel-caption">
            <h3>Kamar Tidur Utama Keluarga Ratnasari </h3>
            <p>by Malina Saumnuari </p>
          </div>
		    ...
		    <div class="container-fluid">
		        <div class="row no-gutter">
		            <div class="col-lg-3 col-sm-8">
		                <a href="category.php?rowid=ruang_keluarga" class="portfolio-box">
		            ...
		            <div class="col-lg-3 col-sm-8">
		                <a href="category.php?rowid=ruang_kerja" class="portfolio-box">
		            ...
		            <div class="col-lg-3 col-sm-8">
		                <a href="category.php?rowid=kamar_mandi" class="portfolio-box">
		            ...
		            <div class="col-lg-3 col-sm-8">
		                <a href="category.php?rowid=kamar_tidur" class="portfolio-box">
		            ...
		            <div class="col-lg-3 col-sm-8">
		                <a href="category.php?rowid=ruang_tamu" class="portfolio-box">
		            ...
		            <div class="col-lg-3 col-sm-8">
		                <a href="category.php?rowid=dapur" class="portfolio-box">
		            ...
		            <div class="col-lg-3 col-sm-8">
		                <a href="category.php?rowid=taman" class="portfolio-box">
		            ...
		            <div class="col-lg-3 col-sm-8">
		                <a href="category.php?rowid=ruang_makan" class="portfolio-box">
